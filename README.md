...
**本書の内容はすべて生成 AI (ChatGPT または Claude) によって執筆されています。**
...
### [第 0 部：環境構築とクイックスタート](./第0部/)

本書を始める前に必要な環境構築と、最初の GPU プログラムを実行します。

#### [第 0 章：開発環境のセットアップ](./第0部/0-0-開発環境のセットアップ.md)
...
#### [第 1 章：GPU ネイティブ機械学習とは何か](./第1部/1-1-GPUネイティブ機械学習とは何か.md)
...
#### [第 2 章：線形代数と数値計算の基礎](./第1部/1-2-線形代数と数値計算の基礎.md)
...
#### [第 3 章：自動微分の仕組み](./第1部/1-3-自動微分の仕組み.md)
...
### [第 II 部：Rust による数値処理と安全設計](./第2部/)

Rust の型システム、所有権、並列処理を活用した安全な数値計算を実装します。

#### [第 4 章：Rust 数値計算の基礎構文](./第2部/2-4-Rust数値計算の基礎構文.md)
...
#### [第 5 章：並列計算と非同期処理](./第2部/2-5-並列計算と非同期処理.md)
...
### [第 III 部：GPU プログラミング入門](./第3部/)

GPU アーキテクチャの理解から、Rust による実践的な GPU プログラミングまで。

#### [第 6 章：GPU アーキテクチャの理解](./第3部/3-6-GPUアーキテクチャの理解.md)
...
#### [第 7 章：Rust から GPU を操作する](./第3部/3-7-RustからGPUを操作する.md)
...
#### [第 8 章：GPU メモリ管理と最適化](./第3部/3-8-GPUメモリ管理と最適化.md)
...
### [第 IV 部：機械学習エンジンの構築](./第4部/)

テンソル演算、学習ループ、最適化アルゴリズムを実装し、実用的な ML エンジンを構築します。

#### [第 9 章：テンソル・オペレーター設計](./第4部/4-9-テンソル・オペレーター設計.md)
...
#### [第 10 章：学習ループと最適化手法](./第4部/4-10-学習ループと最適化手法.md)
...
#### [第 11 章：デバッグとプロファイリング](./第4部/4-11-デバッグとプロファイリング.md)
...
#### [第 12 章：モデル推論と ONNX 互換](./第5部/5-12-モデル推論とONNX互換.md)
...
#### [第 13 章：コンパイラ最適化と DSL 設計](./第5部/5-13-コンパイラ最適化とDSL設計.md)
...
#### [第 14 章：分散・クラスタ対応](./第5部/5-14-分散・クラスタ対応.md)
...
#### [第 15 章：セキュリティと信頼性](./第5部/5-15-セキュリティと信頼性.md)
...
### [第 VI 部：ケーススタディと実践](./第6部/)

CNN、RNN、Transformer などの実用的なモデルを Rust で実装し、エンドツーエンドで最適化します。

#### [第 16 章：CNN・RNN・Transformer を実装する](./第6部/6-16-CNN・RNN・Transformerを実装する.md)
...
#### [第 17 章：エンドツーエンド最適化](./第6部/6-17-エンドツーエンド最適化.md)
...
#### [第 18 章：実践プロジェクト](./第6部/6-18-実践プロジェクト.md)
...
#### [第 19 章：Rust での ML エコシステムの進化](./第7部/7-19-RustでのMLエコシステムの進化.md)
...
**初学者向け**：第 0 部から順番に読み進めることをお勧めします。特に、第 0 ～ 3 章は本書全体の基礎となるため、丁寧に読み進めてください。
